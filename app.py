          ...
          <div className="properties-panel">
            ...
            {selectedNode ? (
              <>
                ...
                <div className="metrics-card">
                  ...
                  <div className="metric-row">
                    <span>التيار المار (I):</span>
                    <strong>{i.toFixed(3)} A</strong>
                  </div>
                  <div className="metric-row">
                    <span>القدرة المستهلكة (P):</span>
              ...
              <p style={{ color: '#94a3b8', textAlign: 'center', marginTop: '40px' }}>
                اضغط على أي عنصر في المخطط لتعديل قيمه وتفاصيله
              </p>
            )}
          </div>
        </div>
...
# عرض المكون التفاعلي بارتفاع مناسَب
